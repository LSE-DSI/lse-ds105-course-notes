...
Once the password is updated, the connection will be closed and you need to reopen a connection using PuTTY. If your conection has been successfull, you will see a message starting with "Welcome to Ubuntu". Ask your teacher to check if it is done correctly. 
